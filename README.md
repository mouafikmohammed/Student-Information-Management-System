...
## Diagram
   ...
   <img src="image/Diagram.vsdx.jpg" width=450 align=center />
...
### Find the student by the given first name: 
   ...
   <img src="image/Search by first name.jpg" width=350 />
   
### Find the students registered in a course: 
   This function is to find all the students who have registered for a given course.
   
   <img src="image/Search by ID course.jpg" width=350 />
   
### Count of Students: 
   This function is to print the total number of students in the system.
   
   <img src="image/result of total students.jpg" width=350 />
   
### Delete a student: 
   This function is to delete the student record for the given roll number.
   
   <img src="image/delete.jpg" width=350 />
### Update Student: 
   This function is to update the student records. This function does not ask for new details for all fields, but the user should be able to pick and choose what he
   wants to update.
   
   <img src="image/Update.jpg" width=350 /> <img src="image/Update2.jpg" width=350 />
### Exit Program: 
   
   <img src="image/Exit program.jpg" width=350 />
